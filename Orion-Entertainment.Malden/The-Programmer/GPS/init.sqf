...
[missionNamespace,"gps_core_loaded",{
	...
	(findDisplay 46) displayAddEventHandler ["KeyDown", "if (((_this select 1) == 39) && (missionNamespace getVariable [""gps_core_init_done"",false])) then {[] call gps_menu_fnc_loadGPSMenu;};"];
