...
class Maverick_ServerRestartEvent {
	...
	MessageRestartAnnounce = "<t size='1.4'>Serverrestart</t><br/><br/><t size='1.25'>The Server will restart in 5 minutes!</t>";
	MessageRestartInit     = "<t size='1.4'>Serverrestart</t><br/><br/><t size='1.25'>We will be back in a moment!</t>";
	MessageEventInit       = "<t size='1.4'>Event</t><br/><br/><t size='1.25'>Search for some cover, or you might die!</t>";
};